                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <a class="dropdown-item" href="<?php print_link('account') ?>"><i class="icon-user"></i> <?php print_lang('my_account'); ?></a>
                            <a class="dropdown-item" href="<?php print_link('index/logout?csrf_token=' . Csrf::$token) ?>"><i class="icon-logout"></i> <?php print_lang('logout'); ?></a>
                        </ul>
                    </li>
                </ul>
            </div>
